...
type Validator struct {
	...
	MinSelfDelegation       sdk.Int        `json:"min_self_delegation"` // validator's self declared minimum self delegation
        VotesCast               sdk.Int        `json:"votes for validator"` // number of votes cast
	VotingValidators        []sdk.ValAddress `json:"array of addresses of voting validator"` // voting validators
}
...
func NewValidator(operator sdk.ValAddress, pubKey crypto.PubKey, description Description) Validator {
	return Validator{
		...
		VotesCast:               sdk.OneInt(),
		VotingValidators:        []sdk.ValAddress
	}
}
...
func (v Validator) GetVotesCast() sdk.Dec         { return v.VotesCast }
func (v Validator) GetVotingValidators() []sdk.ValAddress {return v.VotingValidators } 
