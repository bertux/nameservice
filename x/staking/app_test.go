...
// getEndBlocker returns a staking endblocker. cosmospoa - add poa here
...
func TestStakingMsgs(t *testing.T) {
	...
	// create validator - cosmospoa - add poa
...
// check that a validator is a real validator node
